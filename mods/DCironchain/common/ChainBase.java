...
public abstract class ChainBase extends Block
{
    
    protected final boolean isPowered;
    protected final boolean isStopper;
    ...
    {
        return Block.blocksList[par0] instanceof ChainBase;
    }

    protected ChainBase(int par1, boolean par2, boolean par3)
    {
