...
import mods.DCironchain.common.material.BlockRHopper;
...
public class TileEntityHopperGold extends TileEntityRHopper
{
    ...
    //インベントリから
    protected static boolean insertStackFromInventory(Hopper par0Hopper, IInventory par1IInventory, int par2, int par3)
    {
